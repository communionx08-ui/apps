...
import 'rider_smileid_selfie_screen.dart';

class RiderSmileIdDocumentCaptureScreen extends StatefulWidget {
  final String givenNames;
  final String lastName;
  final String email;
  final String idType;

  const RiderSmileIdDocumentCaptureScreen({
    super.key,
  ...
  @override
  State<RiderSmileIdDocumentCaptureScreen> createState() =>
      _RiderSmileIdDocumentCaptureScreenState();
}

class _RiderSmileIdDocumentCaptureScreenState
    extends State<RiderSmileIdDocumentCaptureScreen> {
