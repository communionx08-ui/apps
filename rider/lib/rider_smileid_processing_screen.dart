...
import 'rider_personal_information_screen.dart';

class RiderSmileIdProcessingScreen extends StatefulWidget {
  ...
  const RiderSmileIdProcessingScreen({
    super.key,
  ...
  @override
  State<RiderSmileIdProcessingScreen> createState() =>
      _RiderSmileIdProcessingScreenState();
}

class _RiderSmileIdProcessingScreenState
    extends State<RiderSmileIdProcessingScreen> {
    ...
    Navigator.pushAndRemoveUntil(
      ...
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) =>
            RiderPersonalInformationScreen(
