            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Header with vendor-style animation
                  Text(
                    'Set Your Default\nDelivery Address',
                  ...
                  Text(
                    ...
                    style: AppTypography.body(AppColors.textSecondary).copyWith(
                      ...
                      // Current Location Toggle with vendor styling
                      Container(
                      ...
                      // Address Input (with vendor-style animations)
                      _buildInputField(
                        'Full Address',
  ...
  Widget _buildInputField(
    ...
    return Column(
      ...
      children: [
        ...
        .animate()
        .fadeIn(delay: (900 + (index * 120)).ms, duration: 400.ms, curve: Curves.easeOut)
        .scale(begin: const Offset(0.98, 0.98), delay: (900 + (index * 120)).ms, duration: 500.ms, curve: Curves.easeOutCubic);
  }
}