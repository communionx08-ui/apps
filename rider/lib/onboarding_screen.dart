...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final _pages = const [
    _Page(
      ...
      highlight: 'Repeat',
      highlightAfter: '',
      subtitle: 'Go online and start earning with flexible hours. Deliver and earn consistently.',
    ...
    _Page(
      ...
      highlight: 'Earn',
      highlightAfter: '',
      subtitle: 'Track every delivery, tips, and payout in realtime everyday.',
    ...
    _Page(
      ...
      highlight: 'You',
      highlightAfter: '',
      subtitle: 'Get assigned orders based on your location and availability.',
