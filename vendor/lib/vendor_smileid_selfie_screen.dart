...
import 'vendor_smileid_liveness_screen.dart';

class VendorSmileIdSelfieScreen extends StatefulWidget {
  ...
  const VendorSmileIdSelfieScreen({
    super.key,
  ...
  @override
  State<VendorSmileIdSelfieScreen> createState() =>
      _VendorSmileIdSelfieScreenState();
}

class _VendorSmileIdSelfieScreenState extends State<VendorSmileIdSelfieScreen> {
