...
class VendorSmileIdLivenessScreen extends StatefulWidget {
  ...
  const VendorSmileIdLivenessScreen({
    super.key,
  ...
  @override
  State<VendorSmileIdLivenessScreen> createState() =>
      _VendorSmileIdLivenessScreenState();
}

class _VendorSmileIdLivenessScreenState
    extends State<VendorSmileIdLivenessScreen> {
