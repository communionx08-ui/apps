...
class VendorSmileIdPersonalDetailsScreen extends StatefulWidget {
  ...
  const VendorSmileIdPersonalDetailsScreen({
    super.key,
  ...
  @override
  State<VendorSmileIdPersonalDetailsScreen> createState() =>
      _VendorSmileIdPersonalDetailsScreenState();
}

class _VendorSmileIdPersonalDetailsScreenState
    extends State<VendorSmileIdPersonalDetailsScreen> {
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) =>
            VendorSmileIdDocumentCaptureScreen(
