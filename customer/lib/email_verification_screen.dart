  ...
  Future<void> _verifyEmailCode() async {
    ...
    try {
      ...
      if (code == '123456' || code == '000000') {
        // Success - now collect phone number
        Haptics.success();
        Navigator.pushReplacement(
          context,
          PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) => PhoneCollectionScreen(
              email: widget.email,
              name: widget.name,
            ),
            ...
            children: [
              ...
              Padding(
                ...
                child: SwiftButton(
                  ...
                  onPressed: _enteredCode.length == 6 ? _verifyEmailCode : null,
                ),
              )
                  .animate()
