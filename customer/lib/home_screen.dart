...
import 'screens/errand_selection_screen.dart';
...
import 'screens/parcel_selection_screen.dart';
import 'screens/food_detail_screen.dart';
import 'screens/checkout_screen.dart';
import 'screens/order_tracking_screen.dart';
import '../providers/active_order_provider.dart';
import 'screens/market_shopping_list_screen.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
                      ...
                      children: [
                        ...
                        AnimatedSwitcher(
                          ...
                          child: _isLoading
                              ...
                              : Column(
                                  key: ValueKey('content-$_selectedServiceType'),
                                  children: [
      ...
      sliver: SliverList(
        delegate: SliverChildBuilderDelegate(
          (context, index) {
            ...
            return _buildVerticalVendorCard(vendor, index);
          },
  ...
  Widget _buildVerticalVendorCard(Map<String, dynamic> vendor, int index) {
    ...
    return AnimatedPress(
      onTap: () {
        ...
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (_, __, ___) => RestaurantScreen(restaurantData: vendor),
            transitionsDuration: Motion.page,
            transitionsBuilder: (_, anim, __, child) => FadeTransition(
              opacity: CurvedAnimation(parent: anim, curve: Motion.standard),
              child: SlideTransition(
                position: Tween(begin: const Offset(0.05, 0), end: Offset.zero)
                    .animate(CurvedAnimation(parent: anim, curve: Motion.spring)),
                child: child,
              ),
            ),
          ),
        ...
        child: Column(
          ...
          children: [
            Stack(
              children: [
                Hero(
                  tag: 'vendor-${vendor['name']}-${vendor['img']}',
                  child: ClipRRect(
      ...
      .fadeIn(duration: Motion.normal, curve: Motion.standard)
      .slideY(begin: 0.1, end: 0, curve: Motion.spring);
  }
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, i) {
          ...
          return AnimatedPress(
            ...
            .slideX(begin: 0.1, curve: Motion.spring);
        },
      ),
    );
  }
            ...
            child: AnimatedPress(
              onTap: () {
                ...
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    opaque: false,
                    pageBuilder: (_, __, ___) => VendorStoryScreen(
  ...
  Widget _buildFoodKingBottomNav() {
    ...
    const Color fkPrimary = const Color(0xFF0068FF);
  ...
  Widget _buildFoodItemCard(Map<String, dynamic> item) {
    ...
    const Color fkPrimary = const Color(0xFF0068FF); // Use brand primary instead of pink
