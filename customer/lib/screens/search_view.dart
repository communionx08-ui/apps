  ...
  final List<Map<String, dynamic>> _allItems = [
    {
      ...
      'description': 'Rich, hearty Ghanaian fufu served with fresh light soup and goat meat.',
      'price': 'GH₵ 55.00',
    ...
    },
    {
      ...
      'description': 'Succulent grilled kebab skewers marinated in a spicy Ghanaian blend.',
      'price': 'GH₵ 24.00',
    ...
    {
      'name': 'Waakye & Salad',
      'description': 'Classic Ghanaian waakye (rice & beans) served with fresh vegetable salad.',
      'price': 'GH₵ 30.00',
    ...
    },
    {
      ...
      'description': 'Smoky, well-seasoned Ghanaian jollof rice served with grilled chicken.',
      'price': 'GH₵ 45.00',
