  ...
  Widget _buildTermsTab() {
    const sections = [
      _Section(
        ...
        body:
            'By downloading, accessing, or using the Swift application, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services. These terms constitute a legally binding agreement between you and Swift Technologies Ltd.',
      ),
      _Section(
        title: '2. Use of Service',
        body:
            'Swift grants you a limited, non-exclusive, non-transferable licence to use our platform for personal, non-commercial purposes. You must be at least 18 years old to create an account. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.',
      ),
      _Section(
        title: '3. Orders and Delivery',
        body:
            'When you place an order through Swift, you enter into a direct agreement with the vendor or service provider. Swift acts as an intermediary platform connecting customers, vendors, and riders. Delivery time estimates may vary due to traffic, weather, or vendor preparation times. We strive to provide accurate estimates but cannot guarantee exact delivery windows.',
      ),
      _Section(
        title: '4. Payment',
        body:
            'All payments made through Swift are processed securely via our certified payment partners. We accept MTN Mobile Money, Vodafone Cash, AirtelTigo Money, and cash on delivery where available. Prices displayed include applicable taxes and fees. By completing a purchase, you authorise Swift to charge your selected payment method for the total order amount.',
      ),
      _Section(
      ...
      _Section(
        ...
        body:
            'All content, branding, logos, trademarks, and software associated with Swift are the intellectual property of Swift Technologies Ltd. and its licensors. You may not reproduce, distribute, modify, or create derivative works without our prior written consent. User-generated content remains your property; however, you grant Swift a worldwide, royalty-free licence to use it in connection with our services.',
      ),
      _Section(
        title: '7. Limitation of Liability',
        body:
            'To the maximum extent permitted by applicable law, Swift shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the platform. Our total liability for any claim shall not exceed the amount you paid for the specific transaction giving rise to the claim.',
      ),
      _Section(
        title: '8. Changes to Terms',
        body:
            'Swift reserves the right to modify these Terms of Service at any time. We will notify you of significant changes via the app or email at least 14 days before they take effect. Your continued use of the platform after changes are published constitutes your acceptance of the updated terms. We encourage you to review these terms periodically.',
      ),
    ];
  ...
  Widget _buildPrivacyTab() {
    const sections = [
      ...
      _Section(
        title: '6. Your Rights',
        body:
            'You have the right to access, correct, or delete your personal data at any time from the Profile section of the app. You may also request a portable copy of your data or object to certain types of processing. To exercise any of these rights, contact us at privacy@Swift.com. We aim to respond within 30 days.',
      ),
      _Section(
        title: '7. Contact Us',
        body:
            'If you have questions or concerns about this Privacy Policy or our data practices, please contact our Data Protection team at privacy@Swift.com. You may also write to Swift Technologies Ltd., Accra, Ghana. We take all privacy concerns seriously and will respond as promptly as possible.',
      ),
    ];
