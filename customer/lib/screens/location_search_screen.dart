              ...
              child: Row(
                children: [
                  const Icon(Icons.check_circle,
                      color: const Color(0xFF0068FF), size: 24),
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Enter your Ghana Post GPS digital address code',
              style: AppFonts.inter(
                fontSize: 13,
                color: const Color(0xFF64748B),
              ),
              ...
              child: TextFormField(
                ...
                validator: (v) {
                  if (v == null || v.trim().isEmpty) {
                    return 'Please enter your Ghana Post GPS code';
                  }
                  final pattern =
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Find your GPS code at ghanapostgps.com',
                      style: AppFonts.inter(
                        fontSize: 12,
