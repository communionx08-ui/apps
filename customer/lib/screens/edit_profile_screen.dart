...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    // Restore DOB
    final dobStr = prefs.getString('Swift_user_dob');
    if (dobStr != null) {
      setState(() {
    ...
    // Restore gender
    final gender = prefs.getString('Swift_user_gender');
    if (gender != null) {
      setState(() {
  ...
  Future<void> _save() async {
    ...
    if (_selectedDate != null) {
      await prefs.setString('Swift_user_dob', _selectedDate!.toIso8601String());
    }
    // Persist gender
    if (_selectedGender != null) {
      await prefs.setString('Swift_user_gender', _selectedGender!);
    }
