...
class _HelpSupportScreenState extends State<HelpSupportScreen>
  ...
  final List<_SupportMessage> _chatMessages = [
    _SupportMessage(
      text: 'Hello! Welcome to Swift Support. How can we help you today?',
      isMe: false,
  ...
  final List<Map<String, String>> _faqs = [
    ...
    {
      'q': 'How do I become a Swift rider?',
      'a': 'We are always looking for reliable riders! Visit Swift.com/riders or send an email to riders@Swift.com with your details.',
    },
  ];
  ...
  Widget _buildContactTab() {
    final contacts = [
      ...
      _ContactItem(
        ...
        label: 'Email',
        subtitle: 'support@Swift.com',
        iconBg: const Color(0xFFEFF5FF),
        iconColor: _primary,
        onTap: () => _launch('mailto:support@Swift.com'),
      ),
      _ContactItem(
