        ...
        content: Column(
          ...
          children: [
            if (isPenalty) ...[
              ...
              const SizedBox(height: 12),
              Text('You will receive a 50% refund to your Swift Wallet.', style: AppFonts.inter(fontSize: 14, color: const Color(0xFF64748B))),
            ] else
              Text('Your order will be cancelled and you\'ll receive a full refund to your Swift Wallet within a few minutes.', style: AppFonts.inter(fontSize: 14, color: const Color(0xFF64748B))),
          ],
        ),
        actions: [
          TextButton(
