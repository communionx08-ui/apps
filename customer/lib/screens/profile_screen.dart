...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    if (!mounted) return;
    setState(() {
      _userName = prefs.getString(AppConstants.prefKeyUserName) ?? 'Swift User';
                ...
                children: [
                  ...
                  _buildMenuGroup(
                    ...
                    items: [
                      ...
                      _buildMenuItem(Icons.info_outline, 'About Swift', onTap: () {
                        showAboutDialog(
                          context: context,
                          ...
                          applicationIcon: Image.asset(
                            ...
                            width: 56, height: 56,
                            errorBuilder: (_, __, ___) => Icon(Icons.local_shipping, size: 56, color: const Color(0xFF0068FF)),
                          ),
                          children: [
                            Text(
  ...
  Widget _buildMenuItem(IconData icon, String title, {required VoidCallback onTap}) {
    return ListTile(
      ...
      leading: Container(
        ...
        child: Icon(icon, color: const Color(0xFF0068FF), size: 20),
      ),
      title: Text(
        title,
        style: AppFonts.inter(
